...
стандартной, если все ее идеалы стандартны. Такое определение имеет смысл, когда
точная обертывающая алгебра градуирована системной положительных корней (как
алгебра $N\Phi(\mathbb{K})$).
