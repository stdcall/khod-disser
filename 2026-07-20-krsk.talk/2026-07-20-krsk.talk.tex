...
\date[20.07.2026]{XVI школа-конференция по теории групп,\\посвящённая 80-летию со дня рождения В.\,М.~Левчука\\20 июля 2026}
...
\begin{frame}[t]{План доклада}
    ...
    \begin{alertblock}{Основные результаты}
        \begin{itemize}
            ...
            \item Для $N\Phi(\K)$ типов $B_n$, $C_n$ и $D_n$ левосимметрические
                  точные обертывающие алгебры построены как полупрямые суммы
                  алгебры $NT(n,\mathbb{K})$ и подходящего идеала алгебры
                  $N\Phi(\mathbb{K})$.%, без ограничения на характеристику.
        \end{itemize}
    \end{alertblock}
\end{frame}
...
\begin{frame}[t]{Неассоциативные точные обертывающие алгебры}
    ...
    \begin{itemize}
        ...
        \item В.\,М.~Левчук\sourcefootnote{DAN2018,imm2020} называет алгебру $R$ \term{точной
                  обертывающей алгеброй} для алгебры Ли $\mathfrak{g}$, если
              \[
                  R^{(-)}\simeq \mathfrak{g}.
              \]
    \end{itemize}
...
\begin{frame}[t]{Определение умножения в $R$ по заданной структуре $R^{(-)}$}
    ...
    \begin{itemize}
        ...
        \item По одной лишь структуре $R^{(-)}$ произведение $\circ$ ничем не
              ограничено: любое коммутативное $\circ$ задаёт Ли-допустимую алгебру.
              Задача определения умножения в $R$ становится обозримой лишь при
              дополнительных условиях на $R$ (ассоциативность, левосимметричность и т.\,п.).
...
\begin{frame}[t]{Нильтреугольные алгебры Шевалле}
    ...
    \begin{itemize}
        \item В теории Картана--Киллинга каждой простой комплексной конечномерной алгебре Ли
              $\mathfrak{L}$ сопоставляют единственную с точностью до эквивалентности неразложимую
        ...
        \item Элементы $e_r$ $(r \in \Phi)$ и подходящая база подалгебры Картана алгебры Ли
              $\mathfrak{L}=\mathfrak{L}(\Phi,\mathbb{C})$ задают базис Шевалле с целочисленными
...
\iffalse % --- слайд исключён для 15-минутного регламента (Красноярск) ---
...
\begin{frame}[t]{Градуировка Картана}
    ...
    \begin{itemize}
        ...
        \item В частности, на подалгебре $N\Phi(\K)$ индуцированная градуировка имеет вид
              ...
              \]
              причем все ее нетривиальные (не равные нулю) компоненты одномерны.
    \end{itemize}
\end{frame}
...
\begin{frame}[t]{Эквивалентность градуировок}
    ...
    \begin{block}{Эквивалентность}
        Градуировки $\Gamma_1$ и $\Gamma_2$ называются \term{эквивалентными},
        если существует изоморфизм алгебр $\phi\colon A\to B$ и для любого $g \in G$
...
\begin{frame}[t]{Нильпотентность ассоциативных точных обертывающих алгебр}
    \begin{block}{Лемма}
        Пусть $\mathfrak{g}$ --- конечномерная нильпотентная алгебра Ли такая, что
        \[
            \dim Z(\mathfrak{g})=1,\qquad Z(\mathfrak{g})\subset [\mathfrak{g},\mathfrak{g}].
        \]
        Тогда всякая ассоциативная точная обертывающая алгебра алгебры Ли $\mathfrak{g}$ является
        нильпотентной.
    \end{block}
...
\begin{frame}[t]{Основной результат для типа $A_n$}
    \begin{alertblock}{Теорема}
        Если ассоциативная точная обертывающая алгебра $R$ алгебры Ли
        $N\Phi(\K)$ типа $A_n$ $(n\ge 3)$ допускает градуировку, согласованную с
        градуировкой Картана, то
        \[
            R \simeq NT(n+1,\K).
        \]
    \end{alertblock}
...
\begin{frame}[t]{Существенность требования согласованности с $\Gamma_C$}
    \small
    Если в теореме для типа $A_n$ не требовать существования градуировки,
    согласованной с градуировкой Картана, то алгебра $R$, вообще говоря, не
    обязана быть изоморфной $NT(n+1,\K)$.
...
\begin{frame}[t]{Результаты о полупрямых суммах левосимметрических алгебр}
    \small
    \begin{block}{Теорема}
        %
...
\begin{frame}[t]{Основной результат для типов $B_n$, $C_n$, $D_n$}
    \begin{alertblock}{Теорема}
