...
\newcommand{\thesisSpecialtyBranch}    % Диссертация, отрасль науки
...
\newcommand{\synopsisLibrary}          % Автореферат, где можно ознакомиться с диссертацией
{ФГАОУ ВО <<Сибирский федеральный университет>>\\
\url{https://sfu.ru/ru/science/sci-attestation/dissertations}}
